...
| 「 Microsoft.Network/privateEndpoints/delete" 」、 Microsoft.Compute/availabilitySets/delete" 、 | 展開に失敗したり削除されたりした場合に、Cloud Volumes ONTAP に属するリソースグループからリソースを削除できるようにします。 
