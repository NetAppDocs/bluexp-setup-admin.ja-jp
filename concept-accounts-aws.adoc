...
summary: 1つ以上のAWSアカウントのクレデンシャルを管理できるように、BlueXPでのAWSのクレデンシャルと権限の使用方法を理解しておく必要があります。たとえば、BlueXPにAWSクレデンシャルを追加する方法を確認できます。 
---
= AWS のクレデンシャルと権限
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
1つ以上のAWSアカウントのクレデンシャルを管理できるように、BlueXPでのAWSのクレデンシャルと権限の使用方法を理解しておく必要があります。たとえば、BlueXPにAWSクレデンシャルを追加する方法を確認できます。
