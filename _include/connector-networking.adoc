...
| \shttps：// management.azure.microsoft.scloud\ https://login.microsoftonline.microsoft.scloud https://blob.core.microsoft.scloud \ https://core.microsoft.scloud | をクリックして、Azure IL6リージョン内のリソースを管理します。 
