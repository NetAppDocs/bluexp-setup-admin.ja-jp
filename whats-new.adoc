...
Azure用のコネクタポリシーが更新され、次の権限が追加されました。
...
* https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/whats-new.html["Cloud Volumes ONTAPによる仮想マシンスケールセットのサポートについて"^]
...
=== Cloud Volumes ONTAPのNSSアカウントを変更する
...
link:task-monitor-cm-operations.html#audit-user-activity-in-your-account["タイムラインをテナンシーサービスにフィルタリングする方法について説明します"]。

== 2021年4月11日

=== Cloud Managerへの直接API呼び出し
