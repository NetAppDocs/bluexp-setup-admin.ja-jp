...
==== Docker Engineのサポート26

Docker Engineは、Ubuntu 22.04 LTSにコネクタをインストールする際に必要なコンテナオーケストレーションツールです。

コネクタの3.9.44リリース以降では、_new_connectorのインストールでDocker Engine 26がサポートされるようになりました。

サポートされているDocker Engineバージョンの最新リストは次のとおりです。

* サポートされる最小バージョンは23.0.6です。
* サポートされる最大バージョンは26.0.0です。
