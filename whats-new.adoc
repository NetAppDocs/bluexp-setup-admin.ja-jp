...
+
https://["サポートされているリージョンの完全なリストを表示します"^]

* このリリースのコネクタには、Cloud Volumes ONTAP の機能拡張が含まれています。
+
https://["Cloud Volumes ONTAP の機能拡張について説明します"^]
...
https://["これらの展開モードの詳細については、こちらをご覧ください"]。
...
+
https://["Eメール通知の設定方法については、こちらをご覧ください"]。
...
+
** https://["インターネットにアクセスできない場所にコネクタを取り付けます"^]
** https://["コネクタのBlueXPコンソールにアクセスします"^]
** https://["未割り当てライセンスを追加します"^]
** https://["Cloud Volumes ONTAP の使用を開始します"^]


* このコネクタで、BlueXPからAmazon S3バケットを追加および管理できるようになりました。
+
https://["BlueXPからAWSアカウントに新しいAmazon S3バケットを追加する方法をご確認ください"^]。
...
+
** https://["AWSサブスクリプションを関連付ける方法について説明します"]
** https://["Azureサブスクリプションを関連付ける方法について説明します"]
** https://["Google Cloudサブスクリプションを関連付ける方法について説明します"]


* BlueXPは、コネクタの電源が14日以上切れている場合に通知します。
+
** https://["BlueXP通知についてはこちらをご覧ください"]
** https://["コネクタの動作を維持する理由について説明します"]
...
+
https://["ConnectorのGoogle Cloud権限を表示します"]。
...
* BlueXPコンソールのURLがに更新されました https://[]
...
アカウントに関連付けられた更新トークンが3カ月後に期限切れになると、Cloud ManagerはNetApp Support Site アカウントに関連付けられたクレデンシャルの更新を求めます。 https://["NSS アカウントを管理する方法について説明します"^]
...
+
https://["ONTAP のFSXを発見する方法については、こちらをご覧ください"^]
...
https://["次の例は、コネクタの作成に使用するAWS IAMロールの権限を示しています"]。

また、各ポリシーへのリンクを提供するページも作成しました。 https://["Cloud Managerの権限の概要を確認します"]。
...
+
https://["アカウントでの操作の監視の詳細については、こちらをご覧ください"]。
...
* をサポートするOSでVMインスタンス上のGoogle CloudのConnectorを認定しました https://["シールドVM機能"^]
* このリリースのコネクタには、Cloud Volumes ONTAP の機能拡張も含まれています。 https://["これらの拡張機能について説明します"^]
...
+
https://["IAM ロールを使用してコネクタを作成する方法について説明します"]。
...
このリリースのコネクタには、Cloud Volumes ONTAP の機能拡張が含まれています。 https://["これらの拡張機能について説明します"^]
...
* https://["ネットアップによるアイデンティティ管理での Microsoft Azure AD の使用方法の詳細については、こちらをご覧ください"^]
...
https://["ネットアップの SOC 2 レポートをご覧ください"^]。
...
https://["Cloud Volumes ONTAP による AutoSupport の検証の詳細については、こちらをご覧ください"^]
