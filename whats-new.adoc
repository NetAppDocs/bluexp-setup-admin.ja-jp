...
summary: ネットアップアカウント、コネクタ、クラウドプロバイダのクレデンシャルなど、BlueXP管理機能の新機能をご紹介します。 
---
= 新機能
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
ネットアップアカウント、コネクタ、クラウドプロバイダのクレデンシャルなど、BlueXP管理機能の新機能をご紹介します。
...
+
link:task-manage-user-credentials.html["ユーザクレデンシャルを管理する方法について説明します"]。
