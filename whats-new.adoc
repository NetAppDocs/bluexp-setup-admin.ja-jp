...
* アプリケーションカテゴリには、Storage ViewerとStorage Adminという2つの新しいロールが関連付けられています。
+
https://docs.netapp.com/us-en/bluexp-setup-admin/reference-iam-predefined-roles.html["IAMロールの詳細を読む"]
