...
| バックアップとリカバリ | 2025年2月5日 | にアクセス https://docs.netapp.com/us-en/bluexp-backup-recovery/whats-new.html["BlueXP  バックアップ/リカバリページの新機能"^]し、2025年2月リリースに含まれる変更点を確認してください。 
