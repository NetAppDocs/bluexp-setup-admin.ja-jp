...
AWSにコネクタソフトウェアを手動でインストールする前に、Amazon EC2インスタンスにInstance Metadata Service Version 1（IMDSv1）が必要であることに注意してください。

https://docs.netapp.com/us-en/bluexp-setup-admin/reference-limitations.html["AWSでのIMDSv1の要件の詳細を確認する"]。
