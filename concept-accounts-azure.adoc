...
summary: BlueXPでAzureのクレデンシャルと権限を使用して、1つ以上のAzureサブスクリプションのクレデンシャルを管理する方法について説明します。たとえば、BlueXPにAzureクレデンシャルを追加する方法を確認できます。 
---
= Azure のクレデンシャルと権限
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
BlueXPでAzureのクレデンシャルと権限を使用して、1つ以上のAzureサブスクリプションのクレデンシャルを管理する方法について説明します。たとえば、BlueXPにAzureクレデンシャルを追加する方法を確認できます。
