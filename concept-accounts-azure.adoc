...
summary: 1つ以上のAzureサブスクリプションのクレデンシャルを管理できるように、BlueXPでのAzureクレデンシャルと権限の使用方法を理解しておく必要があります。 
---
= Azure のクレデンシャルと権限
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
1つ以上のAzureサブスクリプションのクレデンシャルを管理できるように、BlueXPでのAzureクレデンシャルと権限の使用方法を理解しておく必要があります。
