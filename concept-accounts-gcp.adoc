...
summary: BlueXPでGoogle Cloudのクレデンシャルと権限を使用して、1つ以上のGoogle Cloudプロジェクトのクレデンシャルを管理する方法について説明します。たとえば、コネクタVMに関連付けられているサービスアカウントの詳細を確認できます。 
---
...
[role="lead"]
BlueXPでGoogle Cloudのクレデンシャルと権限を使用して、1つ以上のGoogle Cloudプロジェクトのクレデンシャルを管理する方法について説明します。たとえば、コネクタVMに関連付けられているサービスアカウントの詳細を確認できます。
