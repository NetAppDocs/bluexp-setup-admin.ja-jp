...
.手順
. の上部から https://cloudmanager.netapp.com["BlueXP"^]をクリックし、 [*Account*] ドロップダウンをクリックします。
+
...
. の上部から https://cloudmanager.netapp.com["BlueXP"^]をクリックし、 [*Account*] ドロップダウンをクリックして、 [*Manage Account*] をクリックします。
+
image:screenshot-manage-account-settings.png["「アカウント」ドロップダウンから利用できる「アカウント設定の管理」オプションを示すスクリーンショット。"]
