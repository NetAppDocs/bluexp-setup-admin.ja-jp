...
summary: BlueXPアカウントは組織にマルチテナンシーを提供するため、分離されたワークスペースでユーザやリソースを整理できます。たとえば、ユーザーのグループは、他のユーザーには表示されないワークスペースにCloud Volumes ONTAP システムを展開および管理できます。 
---
...
[role="lead"]
A_BlueXPアカウント_は組織にマルチテナンシーを提供するため、isolated_workspaces_でユーザとリソースを整理できます。たとえば、ユーザーのグループは、他のユーザーには表示されないワークスペースにCloud Volumes ONTAP システムを展開および管理できます。
